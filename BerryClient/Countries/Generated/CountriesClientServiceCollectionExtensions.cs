...
namespace BerryClient
{
    public static class CountriesClientServiceCollectionExtensions
    {
        ...
        public static IServiceCollection AddCountriesClient(
            this IServiceCollection serviceCollection)
        {
            if (serviceCollection is null)
            {
            ...
            serviceCollection.AddSingleton<ICountriesClient, CountriesClient>();
        ...
        private static IServiceCollection AddResultParsers(
            this IServiceCollection serviceCollection)
        {
            serviceCollection.AddSingleton<IResultParser, MyQueryResultParser>();
            return serviceCollection;
        }
        ...
        private static Func<HttpClient> ClientFactory(IServiceProvider services)
        {
            ...
            return () => clientFactory.CreateClient("CountriesClient");
        }
